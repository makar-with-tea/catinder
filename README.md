...
На данном экране располагается карточка текущего кота, содержащая фото кота и название его породы, а под ней - две кнопки для дизлайка и лайка соответственно. Пользователь может свайпать вправо или нажимать на кнопку "лайк", если кот понравился, и свайпать влево или нажимать на кнопку "дизлайк", если нет. На экране также отображается кнопка для перехода к списку понравившихся котов. При нажатии на карточку кота открывается страница с подробной информацией о его породе.
 ...
 ![image](https://github.com/user-attachments/assets/c44e3345-037c-436f-ac3d-a468ab804c8f)
...
![image](https://github.com/user-attachments/assets/d5e60585-193c-495b-86eb-34e3e9429bb3)

_Рис. 5: Экран списка понравившихся котов_

![image](https://github.com/user-attachments/assets/4170a8a1-0235-430b-a775-a278589d8f57)
